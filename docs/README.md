# Documentação — Guardian Portal

Portal web da **Central de Proteção** do Guardian Sense. Versão atual: ver `lib/app/constants.dart` (`portalVersion`) e `pubspec.yaml`.

| Documento | Conteúdo |
|-----------|----------|
| [Visão geral](visao_geral.md) | Produto, stack, dados e publicação |
| [Fluxo e autenticação](fluxo_e_autenticacao.md) | Login, aceite de privacidade, redirects e QR de identidade |
